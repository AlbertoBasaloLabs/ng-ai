---
name: generating-add
description: "Generates an Architecture Design Document (ADD) for software projects. To be used when designing a product architecture and agents instructions."
--- 
# Generating an ADD
